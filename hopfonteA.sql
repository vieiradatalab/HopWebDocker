-- Dumping structure for table hopfonte.categories
...
-- Dumping data for table hopfonte.categories: ~8 rows (approximately)
...
-- Dumping structure for table hopfonte.customers
...
-- Dumping data for table hopfonte.customers: ~91 rows (approximately)
...
-- Dumping structure for table hopfonte.employee
...
-- Dumping data for table hopfonte.employee: ~9 rows (approximately)
...
-- Dumping structure for table hopfonte.employee_territories.
CREATE TABLE IF NOT EXISTS `employee_territories.` (
  `employee_id` bigint(20) DEFAULT NULL,
  `territory_id` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table hopfonte.employee_territories.: ~49 rows (approximately)
...
-- Dumping structure for table hopfonte.orders
...
-- Dumping data for table hopfonte.orders: ~830 rows (approximately)
...
-- Dumping structure for table hopfonte.order_details
...
-- Dumping data for table hopfonte.order_details: ~2 155 rows (approximately)
...
-- Dumping structure for table hopfonte.products
...
-- Dumping data for table hopfonte.products: ~77 rows (approximately)
...
-- Dumping structure for table hopfonte.region
CREATE TABLE IF NOT EXISTS `region` (
  `region_id` bigint(20) DEFAULT NULL,
  `region_description` varchar(8) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table hopfonte.region: ~4 rows (approximately)
...
-- Dumping structure for table hopfonte.shippers
...
-- Dumping data for table hopfonte.shippers: ~6 rows (approximately)
...
-- Dumping structure for table hopfonte.suppliers
...
-- Dumping data for table hopfonte.suppliers: ~29 rows (approximately)
...
-- Dumping structure for table hopfonte.territories
...
-- Dumping data for table hopfonte.territories: ~53 rows (approximately)
...
-- Dumping structure for table hopfonte.us_states
...
-- Dumping data for table hopfonte.us_states: ~51 rows (approximately)
